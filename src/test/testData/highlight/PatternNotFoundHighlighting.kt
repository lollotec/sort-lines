...
<warning descr="Group pattern not found">    val cicada = 3</warning>
    val beetle: String = "second"

    // sort: { order: asc, split: /:/, key: 1 }
    val deer: String = "fourth"
<warning descr="Split pattern not found">    var earwig = "fifth"</warning>

    // sort: { order: asc, split: / /, key: 4 }
    val gear: String = "seventh"
<warning descr="Key out of range">    var hearth = "eighth"</warning>
}